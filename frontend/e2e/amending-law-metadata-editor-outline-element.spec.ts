...
test.describe("navigate to page", () => {
  ...
  test("display the preview when an outline element is selected", async ({
    ...
    await page.goto(
      "/amending-laws/eli/bund/bgbl-1/2023/413/2023-12-29/1/deu/regelungstext-1/affected-documents/eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/regelungstext-1/edit/2023-12-30/outline/hauptteil-1_abschnitt-1",
    )
