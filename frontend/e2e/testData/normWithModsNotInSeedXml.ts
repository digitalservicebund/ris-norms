// Identical to `normWithModsXml` but all instances of "s419" have been replaced
// by "s4711", and the GUIDs have been changed.
export const normWithModsNotInSeedXml = `<?xml version="1.0" encoding="UTF-8"?>
<!--
  ##################################################################################
...
<akn:akomaNtoso xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.6/"
    ...
    <akn:act name="regelungstext">
            ...
            <akn:identification eId="meta-1_ident-1"
                ...
                <akn:FRBRExpression eId="meta-1_ident-1_frbrexpression-1"
                    ...
                    <akn:FRBRthis eId="meta-1_ident-1_frbrexpression-1_frbrthis-1"
                                  ...
                                  value="eli/bund/bgbl-1/2017/s4711/2017-03-15/1/deu/regelungstext-1"/>
                    <akn:FRBRuri eId="meta-1_ident-1_frbrexpression-1_frbruri-1"
                                 GUID="5a2c4542-56cc-4c70-8b80-e2041b5b75e1"
                                 value="eli/bund/bgbl-1/2017/s4711/2017-03-15/1/deu"/>
                    <akn:FRBRalias eId="meta-1_ident-1_frbrexpression-1_frbralias-1"
                                   ...
                                   value="ba44d2ae-0e73-44ba-850a-932ab2fa4711"/>
                ...
                <akn:FRBRManifestation eId="meta-1_ident-1_frbrmanifestation-1"
                    ...
                    <akn:FRBRthis eId="meta-1_ident-1_frbrmanifestation-1_frbrthis-1"
                                  ...
                                  value="eli/bund/bgbl-1/2017/s4711/2017-03-15/1/deu/regelungstext-1.xml"/>
        ...
        <akn:preface GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff22" eId="einleitung-1">
            <akn:longTitle GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff33" eId="einleitung-1_doktitel-1">
                <akn:p GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff44"
                    ...
                    <akn:docTitle GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff55"
                                  eId="einleitung-1_doktitel-1_text-1_doctitel-1">Dok Title</akn:docTitle>
                </akn:p>
            </akn:longTitle>
            <akn:block name="attributsemantik-noch-undefiniert" GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff66"
                       eId="einleitung-1_block-1">
                <akn:date date="2023-01-01" refersTo="verkuendung-datum" GUID="6c5d6dc7-f14b-4e1d-8f8b-570a13aeff77"
                          eId="einleitung-1_block-1_datum-1"/>
            </akn:block>
        </akn:preface>

        <akn:preamble eId="preambel-1" GUID="d3023c46-1e74-4c1f-b101-b29898267f71">
            <akn:formula eId="preambel-1_formel-1" GUID="1b476669-1cbb-4633-a0ed-04783680b841" refersTo="eingangsformel"
                ...
                <akn:paragraph eId="hauptteil-1_art-3_abs-1"
                    ...
                    <akn:content eId="hauptteil-1_art-3_abs-1_inhalt-1"
                        ...
                        <akn:p eId="hauptteil-1_art-3_abs-1_inhalt-1_text-1"
                               GUID="52406e40-b866-410c-b097-af69e6248f58"> Dieses Gesetz tritt <akn:date eId="hauptteil-1_art-3_abs-1_inhalt-1_text-1_datum-1"
        ...
        <akn:conclusions eId="schluss-1" GUID="5814d07a-3869-489d-b03e-239304e841cb">
         <akn:formula eId="schluss-1_formel-1" GUID="a269a1a9-e8ca-471a-a9d4-ce61e9af05aa"
                      name="attributsemantik-noch-undefiniert" refersTo="schlussformel">
         ...
         <akn:blockContainer eId="schluss-1_blockcontainer-1" GUID="35e11af5-ff7c-4422-af51-87cff3cc7ceb">
            <akn:p eId="schluss-1_blockcontainer-1_text-1" GUID="b55d6230-d71c-49d5-bf86-dab1db53ba6f">
               <akn:location eId="schluss-1_blockcontainer-1_text-1_ort-1" GUID="19ffc7e1-add6-40a4-b9af-2f0927e46e9c"
                             refersTo="attributsemantik-noch-undefiniert">Bonn</akn:location>, den <akn:date
                    eId="schluss-1_blockcontainer-1_text-1_datum-1" GUID="34cf44aa-73a4-4dee-9827-4d890da7aac7"
