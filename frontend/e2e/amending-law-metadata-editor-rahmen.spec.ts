...
/* eslint-disable playwright/expect-expect -- all tests are skipped */
test.skip("skipped as page is used for prototyping", () => {
  ...
  test.describe("XML view", () => {
    ...
    test("shows an error when the XML could not be loaded", async ({
      page,
    }) => {
      // Given
      await page.route(
