...
test.describe("Textkonsolidierung editor", { tag: ["@RISDEV-6833"] }, () => {
  test.describe("loading and saving", () => {
    ...
    test("navigates from expression list", async ({ page }) => {
      ...
      await expect(page).toHaveURL(
        "./verkuendungen/eli/bund/bgbl-1/2017/123/2017-03-15/1/deu/textkonsolidierung/eli/bund/bgbl-1/1964/321/2017-03-16/1/deu",
      )
    })
  ...
  test.describe("404 redirects", () => {
    const expressionUrl =
      "./verkuendungen/eli/bund/bgbl-1/2017/s419/2017-03-15/1/deu/textkonsolidierung/eli/bund/bgbl-1/2017/s593/2017-03-15/1/deu"
  ...
  test.describe("navigating between expressions", () => {
    test("navigates to next expression version via arrow and updates content", async ({
      ...
      const expectedNextUrl =
        "./verkuendungen/eli/bund/bgbl-1/2017/123/2017-03-15/1/deu/textkonsolidierung/eli/bund/bgbl-1/1964/321/2017-05-01/1/deu"
