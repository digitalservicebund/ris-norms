  ...
  test.describe("Textkonsolidierung Editor - 404 redirects", () => {
    ...
    test.skip("navigates to next expression version via arrow and updates content", async ({
      ...
      const expectedNextUrl =
        "./verkuendungen/eli/bund/bgbl-1/2017/s419/2017-03-15/1/deu/regelungstext-verkuendung-1/textkonsolidierung/eli/bund/bgbl-1/2017/s593/2025-05-26/1/deu/regelungstext-verkuendung-1"
