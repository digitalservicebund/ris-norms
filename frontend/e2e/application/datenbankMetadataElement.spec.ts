...
test.describe("navigate to page", { tag: ["@RISDEV-6266"] }, () => {
  test("shows an error when an element page could not be loaded", async ({
    ...
    await page.goto(
      "./datenbank/eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/metadaten/element/art-z6",
    )
  ...
  test("navigates between elements", async ({ page }) => {
    // Given
    await page.goto(
      "./datenbank/eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/metadaten/element/art-z2",
    )
