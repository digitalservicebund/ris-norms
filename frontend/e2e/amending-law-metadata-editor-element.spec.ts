...
test.describe("navigate to page", () => {
  ...
  test("navigates between elements", async ({ page }) => {
    // Given
    await page.goto(
      "/amending-laws/eli/bund/bgbl-1/2023/413/2023-12-29/1/deu/regelungstext-1/affected-documents/eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/regelungstext-1/edit/2023-12-30/hauptteil-1_abschnitt-1_art-2",
    )
...
test.describe("preview", () => {
  ...
  test("shows an error when the preview could not be loaded", async ({
    ...
    // Given
    await page.route(
      /elements\/hauptteil-1_abschnitt-1_art-6\?atIsoDate=/,
      async (request) => {
        await request.abort()
      },
    )
