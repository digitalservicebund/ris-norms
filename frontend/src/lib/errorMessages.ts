...
export const errorMessages = {
  ...
  "/errors/unsupported-element-type": (
    ...
    message: `Element mit Typ ${e.elementType} wird nicht unterstützt`,
  }),
  ...
  "/errors/meta-mod-not-found": (
    ...
    message: `Änderungsbefehl mit eID "${e.eId}" wurde in der Norm "${e.eli}" existiert nicht`,
  }),
  ...
  "/errors/source-href-in-meta-mod-missing": (
    ...
    message: `Bei dem Änderungsbefehl mit eID "${e.eId}" fehlt die Quellstelle`,
  }),
  ...
  "/errors/target-node-not-present": (
    ...
    message: `Der Zielknoten mit eID "${e.targetNodeEid}" ist in der Vorab-Fassung (ZF0) "${e.eli}" nicht vorhanden`,
  }),
  ...
  "/errors/target-and-upto-nodes-not-siblings": (
    ...
    title: '"Bis-Angabe" nicht in derselben Hierarchieebene',
  ...
  "/errors/character-range-not-present": (
    ...
    message: `Im Zielelement mit Wert "${e.destinationHref}" des Änderungsbefehl mit eID "${e.eId}" innerhalb der Vorab-Fassung (ZF0) "${e.eli}" ist der Zeichenbereich nicht vorhanden`,
  }),
  ...
  "/errors/character-range-with-invalid-format": (
    ...
    message: `Der angegebene Zeichenbereich "${e.characterRange}" des Änderungsbefehls mit eID "${e.eId}" in der Vorab-Fassung (ZF0) "${e.eli} hat kein gültiges Format"`,
  }),
  ...
  // TODO having e: ErrorResponse<{ errors: string[] }>, was not working
