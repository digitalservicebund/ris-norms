...
describe("findHtmlNodeInLdml", () => {
  it("finds the node (element)", () => {
    ...
    const ldmlDocument = xmlStringToDocument(
      `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="quot-1"><akn:ref eId="quot-1_ref-1">Test</akn:ref></akn:quotedText>`,
    )
...
describe("findOffsetInOtherNode", () => {
  ...
  const ldmlDocument = xmlStringToDocument(
    `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="quot-1"><akn:ref eId="quot-1_ref-1">Test text     with some odd
...
describe("htmlRenderRangeToLdmlDeRange", () => {
  it("creates correct range for a simple range", () => {
    ...
    const ldmlDocument = xmlStringToDocument(
      `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="quot-1"><akn:ref eId="quot-1_ref-1">Test text    123</akn:ref></akn:quotedText>`,
    )
  ...
  it("creates correct range for range over nested element", () => {
    ...
    const ldmlDocument = xmlStringToDocument(
      `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="quot-1">Test <akn:ref eId="quot-1_ref-1">text</akn:ref>    123</akn:quotedText>`,
    )
