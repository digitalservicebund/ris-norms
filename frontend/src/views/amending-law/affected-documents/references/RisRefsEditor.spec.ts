...
describe("risRefsEditor", () => {
  ...
  it("should render the html of the second quotedText of the selected mod", async () => {
    ...
    render(RisModRefsEditor, {
      props: {
        normXml: `
          <akn:act xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/">
            <akn:mod eId='mod-1'>
          ...
          RisRefSelectionPanel: {
            ...
            methods: {
              handleClick() {
                this.$emit(
                  "update:xml-snippet",
                  `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="mod-1_quot-2">NEW XML SNIPPET</akn:quotedText>`,
                )
              },
            },
          },
