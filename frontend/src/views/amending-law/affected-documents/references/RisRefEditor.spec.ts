...
describe("risRefEditor", () => {
  ...
  it("can change href", async () => {
    ...
    await expect.poll(() => emitted("update:xmlSnippet")).toHaveLength(1)
    expect(emitted("update:xmlSnippet")[0]).toEqual([
      '<akn:ref xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.1/" eId="quot-1_ref-1" href="eli/bund/bgbl-1/2001/s1/2022-12-19/1/deu/regelungstext-verkuendung-1/art-4_abs-3.xml">§4 Abs. 3 StVO</akn:ref>',
    ])
  })
