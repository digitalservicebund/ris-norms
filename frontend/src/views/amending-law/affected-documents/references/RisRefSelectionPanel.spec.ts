...
describe("risRefSelectionPanel", () => {
  ...
  it("highlighting a part of the text creates a new akn:ref element, the xmlSnippet is updated and the newly created element is selected", async () => {
    const { emitted } = render(RisRefSelectionPanel, {
      props: {
        xmlSnippet:
          "<akn:quotedText xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" eId='quot-1'>Render of <akn:ref eId='quot-1_ref-1'>a ref</akn:ref> and <akn:ref eId='quot-1_ref-2'>a second ref</akn:ref> and <akn:p eId='quot-1_p-1'>place for a third ref</akn:p></akn:quotedText>",
      },
    })
  ...
  it("click on the delete icon deletes the akn:ref element", async () => {
    const { emitted } = render(RisRefSelectionPanel, {
      props: {
        xmlSnippet:
          "<akn:quotedText xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" eId='quot-1'>Render of <akn:ref eId='quot-1_ref-1'>a ref</akn:ref> and <akn:ref eId='quot-1_ref-2'>a second ref</akn:ref></akn:quotedText>",
      },
    })
    ...
    expect(updateXmlSnippetEvents[0]).toEqual([
      `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" eId="quot-1">Render of a ref and <akn:ref eId="quot-1_ref-2">a second ref</akn:ref></akn:quotedText>`,
    ])
  })
})
