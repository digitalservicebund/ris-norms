...
describe("risRefSelectionPanel", () => {
  ...
  it("click on the delete icon deletes the akn:ref element", async () => {
    ...
    expect(updateXmlSnippetEvents[0]).toEqual([
      `<akn:quotedText xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8/" eId="quot-1">Render of a ref and <akn:ref eId="quot-1_ref-2">a second ref</akn:ref></akn:quotedText>`,
    ])
  })
})
