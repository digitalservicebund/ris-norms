...
describe("useRef", () => {
  ...
  it("should call the update when the refersTo or href change", async () => {
    ...
    const { refersTo, href } = useRef(
      `<akn:ref xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" eId="quot-1_ref-1" href="eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/regelungstext-verkuendung-1/hauptteil-1_abschnitt-erster_art-4_abs-3.xml">§4 Abs. 3 StVO</akn:ref>`,
      updateFn,
    )
