  ...
  describe("getForcePeriod", () => {
    it("should find the force period", () => {
      const node = xmlStringToDocument(`
        <akn:textualMod xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7/" GUID="2e5533d3-d0e3-43ba-aa1a-5859d108eb46" eId="meta-1_analysis-1_activemod-1_textualmod-1" type="substitution">
