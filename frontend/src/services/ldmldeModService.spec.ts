...
describe("ldmldeModService", () => {
  ...
  describe("getQuotedTextSecond", () => {
    it("should find second quoted text", () => {
      const node = xmlStringToDocument(`
        <akn:mod xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" GUID="148c2f06-6e33-4af8-9f4a-3da67c888510" eId="hauptteil-1_art-1_abs-1_untergl-1_listenelem-1_inhalt-1_text-1_ändbefehl-1" refersTo="aenderungsbefehl-ersetzen">
          In
          <akn:ref GUID="61d3036a-d7d9-4fa5-b181-c3345caa3206" eId="hauptteil-1_art-1_abs-1_untergl-1_listenelem-1_inhalt-1_text-1_ändbefehl-1_ref-1" href="eli/bund/bgbl-1/1990/s2954/2022-12-19/1/deu/regelungstext-1/hauptteil-1_abschnitt-erster_art-6_abs-3_inhalt-3_text-1/100-126.xml">§6 Absatz 3 Satz 5</akn:ref>
          werden die Wörter
  ...
  describe("getDestinationRangeHref", () => {
    it("should not find the destination range href", () => {
      ...
      expect(getDestinationRangeFrom(node)).toBeUndefined()
    })

    it("should find the destination range href", () => {
      const node = xmlStringToDocument(`
             <akn:mod xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/"  GUID="5597b2ca-bc99-42d7-a362-faced3cad1c1" eId="hauptteil-1_art-1_abs-1_untergl-1_listenelem-1_inhalt-1_text-1_ändbefehl-1" refersTo="aenderungsbefehl-ersetzen">
