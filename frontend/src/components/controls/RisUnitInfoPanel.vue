...
import RisPropertyInfo from "@/components/controls/RisPropertyInfo.vue"

interface RisPropertyInfo {
  label: string
  value?: string
}
...
<template>
  ...
  >
    <div
      ...
      data-testid="norm-unit-info-panel-items"
    >
