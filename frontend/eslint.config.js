...
export default defineConfigWithVueTs([
...

  {
    ...
    rules: {
      ...
      // The following accessibility rules are incompatible with how how many
      // PrimeVue components implement their labelling, leading to errors even
      // when the components are in fact correctly labelled.
      ...
      // Make it clear which imports are actual JavaScript imports and which are
      // "only" types. This makes code more readable, but also prevents issues
      // where Vite occasionally gets confused when types and exports have the
      // same name.
