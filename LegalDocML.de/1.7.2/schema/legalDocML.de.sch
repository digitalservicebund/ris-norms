...
<sch:schema xmlns:fkt="lokale-funktionen"
            ...
            queryBinding="xslt2"
            schemaVersion="LegalDocML.de 1.7.2 (16.01.2025)">
<!--
...
-->
   ...
   <sch:ns uri="http://Inhaltsdaten.LegalDocML.de/1.7.2/" prefix="akn"/>
   <sch:ns uri="http://Metadaten.LegalDocML.de/1.7.2/" prefix="meta"/>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00120"
         ...
         <sch:assert id="SCH-00120-000"
                     test="(@refersTo = ($refersto-literal-mantelform, $refersto-literal-stammform, $refersto-literal-geltungszeitregel, $refersto-literal-vertragsgesetz, $refersto-literal-vertragsverordnung))">Wird innerhalb eines Änderungsbefehls eine Einzelvorschrift in Gänze geändert, neugefasst, hinzugefügt oder gelöscht, so muss diese näher - als Mantelform oder Stammform, als Geltungszeitregel oder als Vertragsgesetz bzw. Vertragsverordnung - bestimmt werden.</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern>
      <sch:rule id="SCH-00121"
         ...
         <sch:assert id="SCH-00121-000"
                     test=". = ($refersto-literal-hauptaenderung, $refersto-literal-folgeaenderung, $refersto-literal-eingebundene-stammform, $refersto-literal-geltungszeitregel)">Liegt ein Regelungstext in Mantelform vor und seine Einzelvorschriften sind mittels @refersTo näher bestimmt, so dürfen lediglich folgende Literale verwendet werden: "hauptaenderung", "folgeaenderung", "eingebundene-stammform", "geltungszeitregel".</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern>
      <sch:rule id="SCH-00122"
         ...
         <sch:assert id="SCH-00122-000"
                     test=". = $refersto-literal-geltungszeitregel and count(//akn:article/@refersTo) = 1">Ein Regelungstext in Stammform darf als nähere Bestimmung seiner Einzelvorschriften (mittels @refersTo) höchstens genau eine Geltungszeitregel und keine sonstigen besitzen.</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern>
      <sch:rule id="SCH-00123"
         ...
         <sch:assert id="SCH-00123-000"
                     test="@refersTo = ($refersto-literal-hauptaenderung, $refersto-literal-folgeaenderung, $refersto-literal-geltungszeitregel)">Eine Einzelvorschrift, die einen Änderungsbefehl beinhaltet, muss entweder als Hauptänderung, Folgeänderung oder als Geltungszeit ausgezeichnet werden.</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00160"
         ...
         <sch:assert id="SCH-00160-010"
                     role="error"
                     test="count(//akn:article[@refersTo = $refersto-literal-geltungszeitregel]) = 1">Innerhalb eines Regelungstextes (sowohl in der Entwurfs- als auch der Verkündungsfassung), der in Stamm- oder Mantelform vorliegt, muss es genau eine Einzelvorschrift bezüglich der Geltungszeit geben.</sch:assert>
      </sch:rule>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00305" context="meta:vomHdrAbweichendeGliederung">
      ...
      <sch:rule id="SCH-00306"
         ...
         <sch:assert id="SCH-00306-000"
                     role="error"
                     test="exists(//meta:vomHdrAbweichendeGliederung)">Eine Gliederungsebene darf nur als von den Regelungen des HdR abweichend gekennzeichnet werden, wenn im Metadatenblock der instanz-weite Marker <code>&lt;meta:vomHdrAbweichendeGliederung&gt;</code> vorhanden ist.</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00310"
         ...
         <sch:report id="SCH-00310-005"
                     role="error"
                     test="./akn:blockContainer and $bearbeitende-institution = 'bundesregierung'">Der Signaturblock steht nur dem Bundestag in der Entwurfsfassung optional zur Verfügung.</sch:report>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00330" context="//akn:doc[@name = $art-vorblatt]/akn:mainBody">
         <sch:assert id="SCH-00330-005"
                     role="error"
                     test="exists(./akn:hcontainer[@refersTo = 'vorblattabschnitt-problem-und-ziel'])"> Es wird empfohlen, dass ein Vorblattabschnitt 'Problem und Ziel' verwendet wird.</sch:assert>
         <sch:assert id="SCH-00330-010"
                     role="error"
                     test="exists(./akn:hcontainer[@refersTo = 'vorblattabschnitt-loesung'])"> Es wird empfohlen, dass ein Vorblattabschnitt 'Lösung' verwendet wird.</sch:assert>
         <sch:assert id="SCH-00330-015"
                     role="error"
                     test="exists(./akn:hcontainer[@refersTo = 'vorblattabschnitt-alternativen'])"> Es wird empfohlen, dass ein Vorblattabschnitt 'Alternativen' verwendet wird.</sch:assert>
         ...
         <sch:assert id="SCH-00330-025"
                     role="error"
                     test="exists(./akn:hcontainer[@refersTo = 'vorblattabschnitt-erfuellungsaufwand'])"> Es wird empfohlen, dass ein Vorblattabschnitt 'Erfüllungsaufwand' verwendet wird.</sch:assert>
         ...
         <sch:assert id="SCH-00330-050"
                     role="error"
                     test="exists(./akn:hcontainer[@refersTo = 'vorblattabschnitt-weitere-kosten'])"> Es wird empfohlen, dass ein Vorblattabschnitt 'Weitere Kosten' verwendet wird.</sch:assert>
      </sch:rule>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00370"
         ...
         <sch:assert id="SCH-00370-005"
                     role="error"
                     test="count(./akn:mainBody/akn:hcontainer) = 1"> Eine Begründung zu einem Vertragsrechtsakt besitzt genau einen Begründungsabschnitt.</sch:assert>
         <sch:assert id="SCH-00370-010"
                     role="error"
                     test="./akn:mainBody/akn:hcontainer[@refersTo = 'begruendung-besonderer-teil']"> Eine Begründung zu einem Vertragsrechtsakt besitzt einen Begründungsabschnitt 'Besonderer Teil'.</sch:assert>
         <sch:assert id="SCH-00370-015" role="error" test="./akn:conclusions"> Eine Begründung zu einem Vertragsrechtsakt besitzt eine Schlussbemerkung.</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00380"
         ...
         <sch:report id="SCH-00380-005"
                     role="error"
                     test="$bearbeitende-institution = ( 'bundesregierung', 'bundestag', 'bundeskanzler', 'bundespräsident', 'nicht-vorhanden' ) and ./akn:mainBody/akn:p/akn:date[@refersTo = 'fristablauf-datum']"> Das Fristablaufsdatum steht nur dem Bundesrat optional zur Verfügung.</sch:report>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00430"
         ...
         <sch:let name="vorgänger-eid" value="(ancestor::*/@eId)[last()]"/>
   ...
   <sch:pattern>
      <sch:rule id="SCH-00435"
         ...
         <sch:assert id="SCH-00435-000" test="starts-with(., '#')">Die Zielangabe einer Textänderung innerhalb von "aenderungenPassiv" (also: akn:passiveModifications/akn:textualMod/akn:destination/@href) muss stets einen Verweis auf ein Element innerhalb des aktuellen Dokumentes enthalten. Solche lokalen Verweise beginnen zwingend mit einer Raute ("#").</sch:assert>
   ...
   <sch:pattern>
      ...
      <sch:rule id="SCH-00440" context="*[@eId]">
         ...
         <sch:assert id="SCH-00440-000"
                     role="error"
                     test="if ($anzahl-vorgängerelemente-gleichen-typs gt 1) then $anzahl-vorgängerelemente-gleichen-typs eq (xs:int($kontext-eId-ordinalzahl) - 1) else true()">Als Ordinalzahl (Positionsangabe) wurde im vorliegenden Fall "<sch:value-of select="$kontext-eId-ordinalzahl"/>" angegeben. Da diese Positionsangaben der ELI-Kürzel im Dokument fortlaufend vergeben werden müssen, wird an dieser Stelle jedoch der ELI-URI "<sch:value-of select="concat($kontext-eId-ohne-ordinalzahl, '-', $anzahl-vorgängerelemente-gleichen-typs + 1)"/>" erwartet.</sch:assert>
         <sch:assert id="SCH-00440-005"
                     role="error"
                     test="if ($anzahl-vorgängerelemente-gleichen-typs eq 0) then (xs:int($kontext-eId-ordinalzahl) eq 1) else true()">Als Ordinalzahl (Positionsangabe) wurde im vorliegenden Fall "<sch:value-of select="$kontext-eId-ordinalzahl"/>" angegeben. Da es sich hierbei um das erste <sch:value-of select="local-name(.)"/>-Element innerhalb seines Elternelements handelt, wird an dieser Stelle jedoch als @eId "<sch:value-of select="concat($kontext-eId-ohne-ordinalzahl, '-1')"/>" erwartet.</sch:assert>
      </sch:rule>
      ...
      <sch:rule id="SCH-00450" context="@eId">
         ...
         <sch:assert id="SCH-00450-000"
                     role="error"
                     test="count(//*[@eId eq $kontext-eId-inhalt]) eq 1">Eine eId muss dokumentweit einmalig sein; eId "<sch:value-of select="$kontext-eId-inhalt"/>" kommt im vorliegenden Dokument jedoch <sch:value-of select="count(//*[@eId eq $kontext-eId-inhalt])"/>-mal vor!</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      ...
      <sch:rule id="SCH-00620" context="akn:eventRef">
         ...
         <sch:assert id="SCH-00620-000"
                     test="if ($ereignisdatum = $platzhalterwert-bei-unbekanntem-datum) then (ends-with($ereignisart, $literalsuffix-für-unbekanntes-datum)) else true()">Bei Angabe eines unbekannten Ereignisdatums (durch Verwendung des Platzhaltertextes "<sch:value-of select="$platzhalterwert-bei-unbekanntem-datum"/>") muss das zur näheren Bestimmung der Ereignisart im Attribut @refersTo angegebene Literal auf den Ausdruck "<sch:value-of select="$literalsuffix-für-unbekanntes-datum"/>" enden.</sch:assert>
         <sch:assert id="SCH-00620-005"
                     test="if (ends-with($ereignisart, $literalsuffix-für-unbekanntes-datum)) then ($ereignisdatum = $platzhalterwert-bei-unbekanntem-datum) else true()">Für ein Ereignis, dessen Datum noch unbekannt ist (hier: @refersTo = "<sch:value-of select="$ereignisart"/>"), muss in seinem Attribut @date als Platzhalterwert "<sch:value-of select="$platzhalterwert-bei-unbekanntem-datum"/>" angegeben werden.</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern>
      ...
      <sch:rule id="SCH-00803" context="akn:inline">
         ...
         <sch:assert id="SCH-00803-000"
                     test="if (not(@refersTo = 'neuris')) then (@name = 'attributsemantik-noch-undefiniert') else true()">Das Attribut @name darf für akn:inline nur dann mit Freitext befüllt werden, wenn @refersTo='neuris' gegeben ist.</sch:assert>
      </sch:rule>
   </sch:pattern>
