...
Diese Datei ist Bestandteil der Schematronregeln des Standards LegalDocML.de 1.8 (08.05.2025).
...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron">
   ...
   <sch:rule role="error"
      ...
      <sch:assert id="SCH-VERK-valueLiterals.work.FRBRsubtype"
                  test="if ($ist-verkündungsfassung) then (matches(., '^(rechtsetzungsdokument|regelungstext-neufassung|regelungstext-verkuendung|vereinbarung-verkuendung|bekanntmachungstext|bekanntmachungstext-berichtigung|bekanntmachungstext-entscheidung-des-bundesverfassungsgerichts|sonstiges-dokument)(-[0-9]+)$')) else true()">In der Verkündungsfassung ist das Literal "<sch:value-of select="."/>" an dieser Stelle nicht
                                    zulässig. Erlaubt sind ausschließlich Werte, die dem Muster "(rechtsetzungsdokument|regelungstext-neufassung|regelungstext-verkuendung|vereinbarung-verkuendung|bekanntmachungstext|bekanntmachungstext-berichtigung|bekanntmachungstext-entscheidung-des-bundesverfassungsgerichts|sonstiges-dokument)(-[0-9]+)" entsprechen.</sch:assert>
   </sch:rule>
   <sch:rule role="error"
