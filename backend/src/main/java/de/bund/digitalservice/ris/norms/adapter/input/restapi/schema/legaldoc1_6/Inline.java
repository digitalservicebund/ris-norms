...
/**
 * Die Klasse "inline" bündelt Elemente, die nicht in LegalDocML spezifiziert sind, jedoch für das
 * deutsche Anwendungsprofil LegalDocML. de benötigt werden, um zusätzliche Inhalte eines Dokuments
 * auszuzeichnen. Die Bündelung durch die Klasse "inlineelement" beruht ausschließlich auf
 * modellierungstechnischen Erwägungen (z. B. Amtliche Abkürzung).
 *
 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="name" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}nameLiterals.inline" /&gt;
 *       &lt;attribute ref="{http://www.w3.org/XML/1998/namespace}id"/&gt;
 *       &lt;attribute name="refersTo" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}refersToLiterals.inline" /&gt;
 *       &lt;attribute name="GUID" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}GUIDLiterals" /&gt;
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.inline" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Inline {
  ...
  protected NameLiteralsInline name;
  ...
  protected RefersToLiteralsInline refersTo;
  ...
  /**
   * Die Klasse "inline" bündelt Elemente, die nicht in LegalDocML spezifiziert sind, jedoch für das
   * deutsche Anwendungsprofil LegalDocML. de benötigt werden, um zusätzliche Inhalte eines
   * Dokuments auszuzeichnen. Die Bündelung durch die Klasse "inlineelement" beruht ausschließlich
   * auf modellierungstechnischen Erwägungen (z. B. Amtliche Abkürzung).Gets the value of the
   * content property.
   *
   ...
   *
   * @return possible object is {@link NameLiteralsInline }
   */
  public NameLiteralsInline getName() {
    return name;
  }
   ...
   *
   * @param value allowed object is {@link NameLiteralsInline }
   */
  public void setName(NameLiteralsInline value) {
    this.name = value;
  }
   ...
   *
   * @return possible object is {@link RefersToLiteralsInline }
   */
  public RefersToLiteralsInline getRefersTo() {
    return refersTo;
  }
   ...
   *
   * @param value allowed object is {@link RefersToLiteralsInline }
   */
  public void setRefersTo(RefersToLiteralsInline value) {
    this.refersTo = value;
  }
