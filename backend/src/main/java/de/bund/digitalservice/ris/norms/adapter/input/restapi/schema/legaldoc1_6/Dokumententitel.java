...
/**
 * Die Klasse "dokumententitel" wird benutzt, um den Titel eines Dokuments anzugeben. Dies kann
 * beispielsweise der Titel des Rechtsetzungsdokuments insgesamt sein oder der Titel eines
 * Teildokuments des Rechtsetzungsdokuments.
 *
 * <p>Java class for dokumententitel complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="dokumententitel"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.dokumententitel" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Dokumententitel {
   ...
   * Die Klasse "dokumententitel" wird benutzt, um den Titel eines Dokuments anzugeben. Dies kann
   * beispielsweise der Titel des Rechtsetzungsdokuments insgesamt sein oder der Titel eines
   * Teildokuments des Rechtsetzungsdokuments.Gets the value of the content property.
   *
