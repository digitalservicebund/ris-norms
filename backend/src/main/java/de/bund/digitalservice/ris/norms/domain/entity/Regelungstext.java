 ...
 */
@Getter
public class Regelungstext {

  private final Document document;

  public Regelungstext(Regelungstext regelungstext) {
    this.document = (Document) regelungstext.getDocument().cloneNode(true);
  }
  ...
  /**
   * Returns the work Eli of the {@link Regelungstext}.
   *
   * @return The work Eli
   */
  ...
  /**
   * Returns the expression Eli of the {@link Regelungstext}.
   *
  ...
  /**
   * Returns the manifestation Eli of the {@link Regelungstext}.
   *
  ...
  /**
   * Returns the current version GUID as {@link UUID} from the {@link Regelungstext}.
   *
  ...
  public boolean equals(Object object) {
    ...
    Regelungstext norm = (Regelungstext) object;
