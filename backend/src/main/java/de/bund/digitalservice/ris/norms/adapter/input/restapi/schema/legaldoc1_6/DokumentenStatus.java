...
/**
 * Die Klasse "dokumentenStatus" wird benutzt, um den Prozessstatus eines Rechtsetzungsdokuments in
 * der Entwurfsfassung anzugeben (z. B. Referentenentwurf, Regierungsentwurf ect.).
 *
 * <p>Java class for dokumentenStatus complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="dokumentenStatus"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.dokumentenStatus" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class DokumentenStatus {
  ...
  /**
   * Die Klasse "dokumentenStatus" wird benutzt, um den Prozessstatus eines Rechtsetzungsdokuments
   * in der Entwurfsfassung anzugeben (z. B. Referentenentwurf, Regierungsentwurf ect.).Gets the
