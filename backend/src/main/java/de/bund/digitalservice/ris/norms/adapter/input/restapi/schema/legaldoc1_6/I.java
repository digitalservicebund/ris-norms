...
/**
 * Die Klasse "i" ist sinngemäß aus HTML übernommen und markiert Text, der kursiv (italic)
 ...
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.i" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class I {
  ...
  /**
   * Die Klasse "i" ist sinngemäß aus HTML übernommen und markiert Text, der kursiv (italic)
   * dargestellt werden soll.Gets the value of the content property.
   *
