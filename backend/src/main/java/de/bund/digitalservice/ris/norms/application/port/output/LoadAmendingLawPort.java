...
/**
 * Interface representing a port for loading a {@link AmendingLaw} based on the ELI (European
 * Legislation Identifier). Implementations of this interface should provide functionality to load a
 * amending law using the specified command.
 */
public interface LoadAmendingLawPort {

  /**
   * Loads a {@link AmendingLaw} based on the provided ELI specified in the command.
   *
   ...
   *     found.
   */
  Optional<AmendingLaw> loadAmendingLawByEli(final Command command);
