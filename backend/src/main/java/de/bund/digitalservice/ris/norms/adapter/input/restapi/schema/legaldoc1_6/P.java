...
/**
 * Die Klasse "p" wird verwendet, um einen Textabsatz einzufügen. Dieser kann aus verschiedenen
 * Inlineelementen bestehen und unterliegt im Gegensatz zu einem juristischen Absatz keinen
 ...
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.p" /&gt;
...
public class P {
   ...
   * Die Klasse "p" wird verwendet, um einen Textabsatz einzufügen. Dieser kann aus verschiedenen
   * Inlineelementen bestehen und unterliegt im Gegensatz zu einem juristischen Absatz keinen
   * strukturellen Vorgaben.Gets the value of the content property.
   *
