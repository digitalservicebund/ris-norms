...
/**
 * Die Klasse "span" ist sinngemäß aus HTML übernommen und wird für generische Inlineelemente
 * genutzt.
 *
 ...
 *       &lt;attribute name="eId" use="required" type="{http://Inhaltsdaten.LegalDocML.de/1.6/}eIdLiterals.span" /&gt;
...
public class Span {
  ...
  /**
   * Die Klasse "span" ist sinngemäß aus HTML übernommen und wird für generische Inlineelemente
   * genutzt.Gets the value of the content property.
   *
