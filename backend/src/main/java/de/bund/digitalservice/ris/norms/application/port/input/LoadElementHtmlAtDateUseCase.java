...
/** Use case for getting a single element as an HTML string. */
public interface LoadElementHtmlAtDateUseCase {
  /**
   ...
   */
  String loadElementHtmlAtDate(LoadElementHtmlAtDateUseCase.Query query);
