...
UPDATE norm_manifestation SET eli_norm_work = (SELECT dokumente.eli_norm_work FROM dokumente WHERE dokumente.eli_norm_manifestation = norm_manifestation.eli_norm_manifestation);
