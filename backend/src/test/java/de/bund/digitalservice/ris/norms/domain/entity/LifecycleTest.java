  ...
  void getEventRefEId() {
    ...
    final Lifecycle lifecycle = Lifecycle
      ...
      .node(
        XmlMapper.toNode(
          """
           <akn:lifecycle xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7/" eId="meta-1_lebzykl-1" GUID="4b31c2c4-6ecc-4f29-9f79-18149603114b" source="attributsemantik-noch-undefiniert">
