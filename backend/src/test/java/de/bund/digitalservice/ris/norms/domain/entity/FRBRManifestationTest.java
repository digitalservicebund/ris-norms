...
class FRBRManifestationTest {
  ...
  void getFRBRthisEli() {
    final FRBRManifestation frbrManifestation = new FRBRManifestation(
      XmlMapper.toElement(
        """
         <akn:FRBRManifestation xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" eId="meta-n1_ident-n1_frbrexpression-n1" GUID="4cce38bb-236b-4947-bee1-e90f3b6c2b8d">
