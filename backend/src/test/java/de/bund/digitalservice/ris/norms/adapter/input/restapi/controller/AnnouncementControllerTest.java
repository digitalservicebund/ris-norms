...
class AnnouncementControllerTest {
  ...
  class getAllAnnouncements {
    ...
    void itReturnsAnnouncements() throws Exception {
      ...
      mockMvc
          ...
          .andExpect(
              jsonPath(
                  "$[0].title", equalTo("Gesetz zur Regelungs des öffenltichen Vereinsrechts")))
          .andExpect(
              jsonPath(
                  "$[0].eli",
  ...
  void itReturnsRelease() throws Exception {
    ...
    when(loadTargetNormsAffectedByAnnouncementUseCase.loadTargetNormsAffectedByAnnouncement(any()))
