...
class ProprietaryControllerTest {
  ...
  //                                <!-- Die vorliegende Angabe von meta:fna stellt einen
  // beliebigen, exemplarischen Fundstellennachweis dar und besitzt keine fachliche Korrektheit. -->
  //                                <meta:fna>754-28-1</meta:fna>
  //                                <!-- Die vorliegende Angabe von meta:gesta besitzt keine
  // fachliche Korrektheit. -->
  //                                <meta:gesta>nicht-vorhanden</meta:gesta>
  //                                <!-- Die vorliegenden Angaben von meta:federfuehrung besitzen
  // keine fachliche Korrektheit. -->
  //                                <meta:federfuehrung>
  //                                    <meta:federfuehrend ab="2002-12-01"
  // bis="unbestimmt">Bundesministerium des Innern und für Heimat</meta:federfuehrend>
  //                                    <meta:federfuehrend ab="2002-10-01"
  // bis="2002-12-01">Bundesministerium der Justiz</meta:federfuehrend>
  //                                </meta:federfuehrung>
  //                            </meta:legalDocML.de_metadaten>
  //                        </akn:proprietary>
  //            """;
  //    var proprietary = Proprietary.builder().node(XmlMapper.toNode(proprietaryNodeText)).build();
  //    when(proprietaryService.loadProprietaryFromNorm(new
  // LoadProprietaryFromNormUseCase.Query(eli)))
  //        .thenReturn(Optional.of(proprietary));
  //    // when
  //    mockMvc
  //        .perform(
  //            get("/api/v1/norms/" + eli +
  // "/proprietary").accept(MediaType.APPLICATION_JSON_VALUE))
  //        // then
  //        .andExpect(status().isOk())
