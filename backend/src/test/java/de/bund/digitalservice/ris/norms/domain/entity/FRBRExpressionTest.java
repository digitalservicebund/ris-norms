...
class FRBRExpressionTest {
  ...
  void getFRBRaliasPreviousVersionId() {
    final FRBRExpression frbrExpression = new FRBRExpression(
      XmlMapper.toElement(
        """
        <akn:FRBRExpression xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="meta-n1_ident-n1_frbrexpression-n1" GUID="4cce38bb-236b-4947-bee1-e90f3b6c2b8d">
  ...
  @Test
  void deleteAliasPreviousVersionId() {
    final FRBRExpression frbrExpression = new FRBRExpression(
      XmlMapper.toElement(
        """
        <akn:FRBRExpression xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="meta-n1_ident-n1_frbrexpression-n1" GUID="4cce38bb-236b-4947-bee1-e90f3b6c2b8d">
    ...
    frbrExpression.deleteAliasPreviousVersionId();
