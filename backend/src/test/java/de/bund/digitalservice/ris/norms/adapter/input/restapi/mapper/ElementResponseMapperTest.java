...
class ElementResponseMapperTest {
  ...
  void convertsAnArticleNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:article xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" GUID="000" eId="art-z1" refersTo="stammform">
  ...
  void convertsABookToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:book xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="hauptteil-n1_buch-n1" GUID="3c36aeed-d116-47c1-b475-a5e8bdfefe63">
        <akn:num
  ...
  void convertsAPartToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:part xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsAChapterToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:chapter xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsASectionToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:section xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsASubsectionToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:subsection xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsATitleToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:title xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsASubtitleToNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:subtitle xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/"
  ...
  void convertsAPrefaceNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:preface xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="einleitung-n1" GUID="000">
  ...
  void convertsAPreambleNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:preamble xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="preambel-n1" GUID="000">
  ...
  void convertsAConclusionsNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:conclusions xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="schluss-n1" GUID="000">
        <akn:formula></akn:formula>
  ...
  void convertsAnArbitraryNode() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:someRandomNode xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="random-n1" GUID="000">
      </akn:someRandomNode>
      """
    );
  ...
  void throwsWhenConvertingANodeWithoutEid() {
    ...
    var node = XmlMapper.toElement(
      """
      <akn:preface xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" GUID="000">
        <akn:longTitle></akn:longTitle>
        <akn:block></akn:block>
      </akn:preface>
      """
