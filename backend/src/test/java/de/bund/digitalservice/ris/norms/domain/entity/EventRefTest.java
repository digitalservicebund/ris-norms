...
class EventRefTest {
  ...
  void getDate() {
    final EventRef eventRef = new EventRef(
      XmlMapper.toElement(
        """
         <akn:eventRef xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.1/" eId="meta-n1_lebzykl-n1_ereignis-n1" GUID="44e782b4-63ae-4ef0-bb0d-53e42696dd06" date="2017-03-15" source="attributsemantik-noch-undefiniert" type="generation" refersTo="ausfertigung" />
        """
      )
    );
  ...
  void getDateEmpty() {
    final EventRef eventRef = new EventRef(
      XmlMapper.toElement(
        """
        <akn:eventRef xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.1/" eId="meta-n1_lebzykl-n1_ereignis-n1" GUID="44e782b4-63ae-4ef0-bb0d-53e42696dd06" source="attributsemantik-noch-undefiniert" type="generation" refersTo="ausfertigung" />
                       """
      )
    );
