...
class EventRefTest {
  ...
  void getDate() {
    final EventRef eventRef = new EventRef(
      XmlMapper.toElement(
        """
         <akn:eventRef xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="meta-n1_lebzykl-n1_ereignis-n1" GUID="44e782b4-63ae-4ef0-bb0d-53e42696dd06" date="2017-03-15" source="attributsemantik-noch-undefiniert" type="generation" refersTo="ausfertigung" />
        """
      )
    );
  ...
  void getDateEmpty() {
    final EventRef eventRef = new EventRef(
      XmlMapper.toElement(
        """
        <akn:eventRef xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="meta-n1_lebzykl-n1_ereignis-n1" GUID="44e782b4-63ae-4ef0-bb0d-53e42696dd06" source="attributsemantik-noch-undefiniert" type="generation" refersTo="ausfertigung" />
                       """
      )
    );
  ...
  void createEventRef() {
    ...
    final Lifecycle lifecycle = new Lifecycle(
      XmlMapper.toElement(
        """
         <akn:lifecycle xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8.2/" eId="meta-n1_lebzykl-n1" GUID="4b31c2c4-6ecc-4f29-9f79-18149603114b" source="attributsemantik-noch-undefiniert">
