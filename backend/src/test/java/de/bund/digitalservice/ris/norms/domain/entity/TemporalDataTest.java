  ...
  void getTemporalGroups() {
    ...
    final TemporalData temporalData = TemporalData
      ...
      .node(
        XmlMapper.toNode(
          """
                 <akn:temporalData xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7/" eId="meta-1_geltzeiten-1" GUID="58a31120-e277-4a33-a093-6a3637fd603d" source="attributsemantik-noch-undefiniert">
