...
class ArticleTest {
  ...
  void getGuid() {
    ...
    String articleString =
      """
      <akn:article xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="hauptteil-1_art-1" GUID="cdbfc728-a070-42d9-ba2f-357945afef06" period="#geltungszeitgr-1" refersTo="hauptaenderung"></akn:article>
      """;
  ...
  void getEnumeration() {
    ...
    String articleString =
      """
      <akn:article xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" eId="hauptteil-1_art-1" GUID="cdbfc728-a070-42d9-ba2f-357945afef06" period="#geltungszeitgr-1" refersTo="hauptaenderung">
                          ...
                          <akn:p eId="hauptteil-1_art-1_abs-1_untergl-1_listenelem-2_inhalt-1_text-1"
                              ...
                              <akn:mod
                                      ...
                                      GUID="61d3036a-d7d9-4fa5-b181-c3345caa3206"
                                              href="eli/bund/bgbl-1/1964/s593/1964-08-05/1/deu/regelungstext-1/hauptteil-1_art-20_abs-1/100-126.xml">
                                  § 20 Absatz 1 Satz 2
                              </akn:ref> wird
