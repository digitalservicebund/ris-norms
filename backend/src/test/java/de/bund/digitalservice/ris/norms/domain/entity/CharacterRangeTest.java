  ...
  class getNodesInRange {
    ...
    void itShouldFindRangeInAText() {
      ...
      assertThat(XmlMapper.toString(node))
        .isEqualToIgnoringWhitespace(
          """
              <?xml version="1.0" encoding="UTF-8"?><akn:p xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" GUID="ca9f53aa-d374-4bec-aca3-fff4e3485179" eId="text-1">A simple foo of which we want to find a part.</akn:p>
          """
        );
    }
    ...
    void itShouldFindRangeSpanningMultipleNodes() {
      ...
      assertThat(XmlMapper.toString(document))
        .isEqualToIgnoringWhitespace(
          """
              <?xml version="1.0" encoding="UTF-8"?><akn:p xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.1/" GUID="ca9f53aa-d374-4bec-aca3-fff4e3485179" eId="text-1">A new text which we want to find a part.</akn:p>
          """
        );
    }
  }
