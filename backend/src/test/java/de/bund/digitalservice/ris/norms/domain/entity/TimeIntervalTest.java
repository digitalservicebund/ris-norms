...
class TimeIntervalTest {
  ...
  void getEventRefEId() {
    ...
    final TimeInterval timeInterval = new TimeInterval(
      XmlMapper.toElement(
        """
         <akn:timeInterval xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" eId="meta-n1_geltzeiten-n1_geltungszeitgr-n1_gelzeitintervall-n1" GUID="ca9f53aa-d374-4bec-aca3-fff4e3485179" refersTo="geltungszeit" start="#meta-n1_lebzykl-n1_ereignis-n2" />
        """
      )
    );
  ...
  void getEventRefEIdEmpty() {
    ...
    final TimeInterval timeInterval = new TimeInterval(
      XmlMapper.toElement(
        """
        <akn:timeInterval xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7.2/" eId="meta-n1_geltzeiten-n1_geltungszeitgr-n1_gelzeitintervall-n1" GUID="ca9f53aa-d374-4bec-aca3-fff4e3485179" refersTo="geltungszeit" />
                       """
      )
    );
