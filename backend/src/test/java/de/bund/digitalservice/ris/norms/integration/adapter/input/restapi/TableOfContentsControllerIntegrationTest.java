...
class TableOfContentsControllerIntegrationTest extends BaseIntegrationTest {
  ...
  void returnsToc() throws Exception {
    ...
    mockMvc
      ...
      .andExpect(
        jsonPath("$[0].eingebundeneStammformEli").value(
          "eli/bund/bgbl-1/2024/17/2024-01-24/1/deu/2024-01-24/regelungstext-verkuendung-2.xml"
        )
      )
      ...
      .andExpect(jsonPath("$[1].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[2].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[3].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[4].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[5].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[6].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[7].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[8].eingebundeneStammformEli").isEmpty())
      ...
      .andExpect(jsonPath("$[9].eingebundeneStammformEli").isEmpty());
  }
}
