  ...
  void getFRBRthisEli() {
    final FRBRWork frbrWork = FRBRWork
      ...
      .node(
        XmlMapper.toNode(
          """
           <akn:FRBRWork xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7/" eId="meta-1_ident-1_frbrexpression-1" GUID="4cce38bb-236b-4947-bee1-e90f3b6c2b8d">
  ...
  void getFRBRname() {
    final FRBRWork frbrWork = FRBRWork
      ...
      .node(
        XmlMapper.toNode(
          """
          <akn:FRBRWork xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.7/" eId="meta-1_ident-1_frbrwork-1" GUID="3385defa-f0e5-4c6d-a2d4-17388afd5d51">
