...
class FRBRWorkTest {
  ...
  void getFRBRthisEli() {
    final FRBRWork frbrWork = new FRBRWork(
      XmlMapper.toElement(
        """
         <akn:FRBRWork xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8/" eId="meta-n1_ident-n1_frbrexpression-n1" GUID="4cce38bb-236b-4947-bee1-e90f3b6c2b8d">
  ...
  void getFRBRname() {
    final FRBRWork frbrWork = new FRBRWork(
      XmlMapper.toElement(
        """
        <akn:FRBRWork xmlns:akn="http://Inhaltsdaten.LegalDocML.de/1.8/" eId="meta-n1_ident-n1_frbrwork-n1" GUID="3385defa-f0e5-4c6d-a2d4-17388afd5d51">
