...
class ZeitgrenzeTest {
  ...
  void throwsExceptionWhenIdAttributeIsMissing() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" art="inkraft">2020-01-01</norms:geltungszeit>
        """
      ),
      mock()
    );
  ...
  void throwsExceptionWhenArtAttributeIsMissing() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" id="gz-1">2020-01-01</norms:geltungszeit>
        """
      ),
      mock()
    );
  ...
  void throwsExceptionWhenArtValueIsUnknown() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" id="gz-1" art="unknown">2020-01-01</norms:geltungszeit>
        """
      ),
      mock()
    );
  ...
  void throwsExceptionWhenTextContentIsEmpty() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" id="gz-1" art="inkraft"></norms:geltungszeit>
        """
      ),
      mock()
    );
  ...
  void throwsExceptionWhenDateIsInvalid() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" id="gz-1" art="inkraft">2020-01-32</norms:geltungszeit>
        """
      ),
      mock()
    );
  ...
  void getId() {
    var zeitgrenze = new Zeitgrenze(
      XmlMapper.toElement(
        """
        <norms:geltungszeit xmlns:norms="http://MetadatenMods.LegalDocML.de/1.8.2/" id="gz-1" art="inkraft">2020-01-30</norms:geltungszeit>
        """
      ),
      mock()
    );
