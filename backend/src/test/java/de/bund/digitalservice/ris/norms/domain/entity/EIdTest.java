...
class EIdTest {
  ...
  class forNode {
    ...
    @CsvSource(
      {
        "<akn:mod xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.1/\" />,ändbefehl-1",
        "<akn:p xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.1/\"><akn:num><akn:marker>3a</akn:marker>§ 3a</akn:num></akn:p>,text-1",
        "<akn:li value=\"3.\" xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.1/\">Some text</akn:li>,listenelem-1",
      }
    )
