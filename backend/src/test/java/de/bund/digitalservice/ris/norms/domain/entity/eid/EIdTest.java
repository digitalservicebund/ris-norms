...
class EIdTest {
  ...
  void fromNode() {
    ...
    var node = XmlMapper.toElement(
      "<akn:mod xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" eId=\"art-z6_abs-z3_inhalt-n3\" />"
    );
    // when
  ...
  class forNode {
    ...
    @CsvSource(
      {
        "<akn:mod xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" />,ändbefehl-n1",
        "<akn:p xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\"><akn:num><akn:marker>3a</akn:marker>§ 3a</akn:num></akn:p>,text-n1",
        "<akn:li value=\"3.\" xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\">Some text</akn:li>,listenelem-n1",
      }
    )
    ...
    void itShouldProvideEIdForNodeWithParent() {
      var node = XmlMapper.toElement(
        "<akn:mod xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" eId=\"art-z6_abs-z3_inhalt-n3\"><akn:p>Some text</akn:p></akn:mod>"
      );
      // when
    ...
    void itShouldProvideEIdForNodeWithSiblingsWithSameEIdTypeWithoutNestedNum() {
      var node = XmlMapper.toElement(
        "<akn:mod xmlns:akn=\"http://Inhaltsdaten.LegalDocML.de/1.7.2/\" eId=\"art-z6_abs-z3_inhalt-n3\"><akn:p eId=\"art-n6_abs-n3_inhalt-z3_text-n1\">Some text 1</akn:p><akn:ref eId=\"art-z6_abs-z3_inhalt-n3_ref-n1\">Some other element</akn:ref><akn:p eId=\"art-z6_abs-z3_inhalt-n3_text-n1\">Some text 2</akn:p><akn:p eId=\"art-z6_abs-z3_inhalt-n3_text-n2\">Some text 3</akn:p></akn:mod>"
      );
      // when
